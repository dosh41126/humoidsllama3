...
class App(customtkinter.CTk):
    ...
    def setup_gui(self):
        ...
        customtkinter.CTkLabel(self.context_frame, text="Latitude:").grid(row=0, column=0, padx=5, pady=5)
        self.latitude_entry = customtkinter.CTkEntry(self.context_frame, width=80)
        self.latitude_entry.grid(row=0, column=1, padx=5, pady=5)
        customtkinter.CTkLabel(self.context_frame, text="Longitude:").grid(row=0, column=2, padx=5, pady=5)
        self.longitude_entry = customtkinter.CTkEntry(self.context_frame, width=80)
        self.longitude_entry.grid(row=0, column=3, padx=5, pady=5)
        customtkinter.CTkLabel(self.context_frame, text="Weather:").grid(row=1, column=0, padx=5, pady=5)
        self.weather_entry = customtkinter.CTkEntry(self.context_frame, width=180)
        self.weather_entry.grid(row=1, column=1, columnspan=3, padx=5, pady=5)
        customtkinter.CTkLabel(self.context_frame, text="Temperature (°F):").grid(row=2, column=0, padx=5, pady=5)
        self.temperature_entry = customtkinter.CTkEntry(self.context_frame, width=80)
        self.temperature_entry.grid(row=2, column=1, padx=5, pady=5)
        customtkinter.CTkLabel(self.context_frame, text="Last Song:").grid(row=3, column=0, padx=5, pady=5)
        self.last_song_entry = customtkinter.CTkEntry(self.context_frame, width=200)
        self.last_song_entry.grid(row=3, column=1, columnspan=3, padx=5, pady=5)
